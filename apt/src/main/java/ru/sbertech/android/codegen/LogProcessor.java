...
@SupportedAnnotationTypes("ru.sbertech.android.codegen.LogAnnotation")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class LogProcessor extends AbstractProcessor {

    private static final String POSTFIX = "$$$LogGenerated";
    ...
    private TypeMirror getSender(TypeElement element) {
        TypeMirror sender;
        try {
            element.getAnnotation(LogAnnotation.class).value();
    ...
    private void generateMethod(TypeSpec.Builder builder, ExecutableElement element) {
        ...
        if (parameters.isEmpty()) {
            ...
            join(parameters,
                    p -> {
                        ...
                        pList.add("new $T($S, $L", LoggingParams.Param.class, pName, pName);
        ...
        code.addStatement("$T<$T> __params = $L", List.class, LoggingParams.Param.class, params.build());
